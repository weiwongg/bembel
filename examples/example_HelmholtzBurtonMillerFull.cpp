...
int main() {
  ...
  for (auto polynomial_degree : {1, 2, 3}) {
    ...
    for (auto refinement_level : {0, 1, 2, 3}) {
      ...
      /////////////////////////////////////////////////////////////////////////
      // Burton Miller KW
      DiscreteOperator<Eigen::MatrixXcd, HelmholtzBurtonMillerKW>
          // DiscreteOperator<MatrixXcd, HelmholtzBurtonMillerKW>
          do_KW(a_KW);
      do_KW.get_linear_operator().set_wavenumber(wavenumber);
      do_KW.compute();
      // Burton Miller SA
      DiscreteOperator<Eigen::MatrixXcd, HelmholtzBurtonMillerSA>
      ...
      /////////////////////////////////////////////////////////////////////////
      Eigen::MatrixXcd IKW = -0.5 * mass + do_KW.get_discrete_operator();
      Eigen::MatrixXcd ISA =
          -0.5 * do_SA.get_linear_operator().get_ieta() * mass +
          do_SA.get_discrete_operator();
      /////////////////////////////////////////////////////////////////////////
      // solve system
      /////////////////////////////////////////////////////////////////////////
      VectorXcd dirichlet = IKW.partialPivLu().solve(ISA * neumann);
      /////////////////////////////////////////////////////////////////////////
      // reference dirichlet
      /////////////////////////////////////////////////////////////////////////
