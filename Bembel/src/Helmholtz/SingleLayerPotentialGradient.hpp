...
// information.
#ifndef BEMBEL_LINEAROPERATOR_HELMHOLTZ_HELMHOLTZSINGLELAYERPOTENTIALGRADIENT_H_
#define BEMBEL_LINEAROPERATOR_HELMHOLTZ_HELMHOLTZSINGLELAYERPOTENTIALGRADIENT_H_

namespace Bembel {
// forward declaration of class HelmholtzSingleLayerPotentialGradient in order
// to define traits
template <typename LinOp>
class HelmholtzSingleLayerPotentialGradient;

template <typename LinOp>
struct PotentialTraits<HelmholtzSingleLayerPotentialGradient<LinOp>> {
...
template <typename LinOp>
class HelmholtzSingleLayerPotentialGradient
    : public PotentialBase<HelmholtzSingleLayerPotentialGradient<LinOp>,
                           LinOp> {
  // implementation of the kernel evaluation, which may be based on the
  // information available from the superSpace
 public:
  HelmholtzSingleLayerPotentialGradient() {}
  ...
  Eigen::VectorXcd evaluateKernelGrad(const Eigen::Vector3d &x,
    ...
    return c * (std::exp(-i * wavenumber_ * r) * (-1. - i * wavenumber_ * r) / r3) / 4. / BEMBEL_PI;
  }
  //////////////////////////////////////////////////////////////////////////////
  //    setters
  //////////////////////////////////////////////////////////////////////////////
