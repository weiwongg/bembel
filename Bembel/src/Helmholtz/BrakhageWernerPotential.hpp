...
// information.
#ifndef BEMBEL_LINEAROPERATOR_HELMHOLTZ_HELMHOLTZBRAKHAGEWERNERPOTENTIAL_H_
#define BEMBEL_LINEAROPERATOR_HELMHOLTZ_HELMHOLTZBRAKHAGEWERNERPOTENTIAL_H_

namespace Bembel {
// forward declaration of class HelmholtzBrakhageWernerPotential in order to
// define traits
template <typename LinOp>
class HelmholtzBrakhageWernerPotential;

template <typename LinOp>
struct PotentialTraits<HelmholtzBrakhageWernerPotential<LinOp>> {
...
template <typename LinOp>
class HelmholtzBrakhageWernerPotential
    : public PotentialBase<HelmholtzBrakhageWernerPotential<LinOp>, LinOp> {
  // implementation of the kernel evaluation, which may be based on the
  // information available from the superSpace
 public:
  HelmholtzBrakhageWernerPotential() {}
  ...
  evaluateIntegrand_impl(const FunctionEvaluator<LinOp> &fun_ev,
    ...
    auto integrand = evaluateKernel(point, x_f, x_n) * cauchy_value * ws;
