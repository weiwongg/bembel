...
// information.
//
#ifndef BEMBEL_LINEAROPERATOR_HELMHOLTZ_HELMHOLTZBRAKHAGEWERNEGOPERATOR_H_
#define BEMBEL_LINEAROPERATOR_HELMHOLTZ_HELMHOLTZBRAKHAGEWERNEGOPERATOR_H_

namespace Bembel {
// forward declaration of class HelmholtzBrakhageWernerOperator in order to
// define traits
class HelmholtzBrakhageWernerOperator;

template <>
struct LinearOperatorTraits<HelmholtzBrakhageWernerOperator> {
 ...
 */
class HelmholtzBrakhageWernerOperator
    : public LinearOperatorBase<HelmholtzBrakhageWernerOperator> {
  // implementation of the kernel evaluation, which may be based on the
  // information available from the superSpace
 public:
  HelmholtzBrakhageWernerOperator() {}
  template <class T>
  void evaluateIntegrand_impl(
      ...
      Eigen::Matrix<typename LinearOperatorTraits<
                        HelmholtzBrakhageWernerOperator>::Scalar,
    ...
    auto integrand = evaluateKernel(x_f, y_f, y_n) * x_kappa * ws * wt;
  ...
  Eigen::Matrix<std::complex<double>, 1, 1> evaluateFMMInterpolation_impl(
    ...
    intval(0) = evaluateKernel(x_f, y_f, y_n) * x_kappa;

    return intval;
  }

  /**
   * \brief Kernel which combines G_n-0.5*i*kappa*G
   */
  std::complex<double> evaluateKernel(const Eigen::Vector3d &x,
    ...
    return c.dot(y_n) * std::exp(-i * wavenumber_ * r) *
           ...
           0.5 * i * std::exp(-i * wavenumber_ * r) / 4. / BEMBEL_PI / r;
  }
  //////////////////////////////////////////////////////////////////////////////
  //    setters
  //////////////////////////////////////////////////////////////////////////////
