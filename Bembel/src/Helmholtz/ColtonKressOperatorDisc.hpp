...
// information.
//
#ifndef BEMBEL_LINEAROPERATOR_HELMHOLTZ_HELMHOLTZCOLTONkRESSOPERATORDISC_H_
#define BEMBEL_LINEAROPERATOR_HELMHOLTZ_HELMHOLTZCOLTONkRESSOPERATORDISC_H_

namespace Bembel {
// forward declaration of class HelmholtzColtonKressOperatorDisc in order to define
// traits
class HelmholtzColtonKressOperatorDisc;

template <>
struct LinearOperatorTraits<HelmholtzColtonKressOperatorDisc> {
 ...
 */
class HelmholtzColtonKressOperatorDisc
    : public LinearOperatorBase<HelmholtzColtonKressOperatorDisc> {
 ...
 public:
  ...
  void evaluateIntegrand_impl(
      ...
      Eigen::Matrix<
          typename LinearOperatorTraits<HelmholtzColtonKressOperatorDisc>::Scalar,
