...
// information.
#ifndef BEMBEL_UTIL_RANK1UPDATE_H_
#define BEMBEL_UTIL_RANK1UPDATE_H_

#include <Eigen/Core>
#include <Eigen/Sparse>

namespace Eigen {
/// forward definition of the Rank1Update Class in order to define traits
...
namespace internal {
template <typename Derived, typename otherDerived>
struct traits<Rank1Update<Derived, otherDerived>>
...
template <typename Derived, typename otherDerived>
class Rank1Update : public EigenBase<Rank1Update<Derived, otherDerived>> {
 public:
  //////////////////////////////////////////////////////////////////////////////
  ...
  Product<Rank1Update, Rhs, AliasFreeProduct> operator*(
      const MatrixBase<Rhs>& x) const {
    return Product<Rank1Update, Rhs, AliasFreeProduct>(*this, x.derived());
  }
  //////////////////////////////////////////////////////////////////////////////
  /// constructors
  //////////////////////////////////////////////////////////////////////////////
  Rank1Update() {}
  Rank1Update(const EigenBase<Derived>& A, const EigenBase<otherDerived>& B)
 ...
 private:
  ...
  // to be private
  Rank1Update(const Rank1Update<Derived, otherDerived>& H);
  Rank1Update(Rank1Update<Derived, otherDerived>&& H);
  Rank1Update& operator=(const Rank1Update<Derived, otherDerived>& H);
  Rank1Update& operator=(Rank1Update<Derived, otherDerived>&& H);
  const Derived& summand1_;
  const otherDerived& summand2_;
};

/**
 * \brief Implementation of Rank1Update * Eigen::DenseVector through a
 * specialization of internal::generic_product_impl
 */
namespace internal {
template <typename Rhs, typename Derived, typename otherDerived>
struct generic_product_impl<Rank1Update<Derived, otherDerived>, Rhs, SparseShape,
                            DenseShape,
                            GemvProduct>  // GEMV stands for matrix-vector
    : generic_product_impl_base<
          Rank1Update<Derived, otherDerived>, Rhs,
          generic_product_impl<Rank1Update<Derived, otherDerived>, Rhs>> {
  typedef typename Derived::Scalar Scalar;
  template <typename Dest>
  static void scaleAndAddTo(Dest& dst,
                            const Rank1Update<Derived, otherDerived>& lhs,
                            const Rhs& rhs, const Scalar& alpha) {
    dst += alpha * (lhs.get_summand1() * rhs) +
           alpha * lhs.get_summand2() * (lhs.get_summand2().transpose() * rhs);
  }
};
}  // namespace internal
////////////////////////////////////////////////////////////////////////////////
