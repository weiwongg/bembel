...
constexpr double BEMBEL_WAVENUM = 5.0;
constexpr double ROUGH_SCALE =.07;
constexpr double SMOOTH_SCALE =0.0;

////////////////////////////////////////////////////////////////////////////////
/// variables
////////////////////////////////////////////////////////////////////////////////
constexpr double generic_tolerance = 1e-9;
// some not further specified constant
constexpr int MaxP = 50;

// some not further specified constant
constexpr int maximum_quadrature_degree = 20;
...
constexpr double pt_comp_tolerance = 1e-12;
...
constexpr double projector_tolerance = 1e-9;
////////////////////////////////////////////////////////////////////////////////
/// methods
////////////////////////////////////////////////////////////////////////////////
