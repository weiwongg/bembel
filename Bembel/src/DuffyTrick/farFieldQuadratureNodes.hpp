 ...
 **/
template <class T>
Eigen::Matrix<double, SurfacePoint::RowsAtCompileTime, Eigen::Dynamic>
computeFfieldQnodes(const T &super_space, const Cubature &Q) {
  Eigen::Matrix<double, SurfacePoint::RowsAtCompileTime, Eigen::Dynamic>
      ffield_qnodes;
  int next = 0;
  ...
  ffield_qnodes.resize(SurfacePoint::RowsAtCompileTime, nE * Q.xi_.cols());
  SurfacePoint surfpt;
