...
int main(int argc, char *argv[]) {
  ...
  if (!setting.compare("david")) {
    interface_geometry = Geometry("../geo/refined_cube.bpd", 4.0,Eigen::Vector3d(-0.5, -0.5, -0.5));
    sphere_radius = 5.;
    geo_scale = 2.0;
  ...
  // Quadrature method
  /////////////////////////////////////////////////////////////////////////////
  Eigen::VectorXi samples_vec(6);
  samples_vec << 32390,15540,1963,703,338,128; 
  //samples_vec << 54010,3666,980,518,128;
